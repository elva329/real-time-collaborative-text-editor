    ...
    <div className='flex items-center gap-x-0.5'>
      ...
      {isEditing ? (
        <input
          ...
          className='h7 w-10 text-sm text-center border border-neutral-400 bg-transparent focus:outline-none focus:ring-0'
        />
      ) : (
        <button
          className='h7 w-10 text-sm text-center border border-neutral-400 rounded-sm bg-transparent cursor-text'
          onClick={() => {
            setIsEditing(true);
